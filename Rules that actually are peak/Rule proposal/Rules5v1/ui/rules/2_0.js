class Card extends ImageSprite {
     ...
     * @param {{init: {(sprite: Sprite): void}, animation: {(sprite: Sprite): void}}} chargeAnimation
     */
    constructor(width,height,background,
        ...
        if (typeof focus != "function" ||
            ...
            typeof chargeAnimation != "function")
            return;
        this.focus = focus;
        this.unfocus = unfocus;
        this.idle = idle;
        this.subSprites.charges.addAnimation(chargeAnimation);
    }
